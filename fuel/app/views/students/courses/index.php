<div id="contents-wrap">
  <div id="main">
    ...
    <div class="content-wrap payment">
      <p class="catchcopy">Choose the course you like to take</p>
      <ul class="select-course">
        <li>
          <h4> HTML/CSS/JavaScript Course </h4>
          <aside><img src="/assets/img/htmlcssjs.png" alt="html5, css3 and JavaScript"></aside>
