			...
			<div id="content">
				<div id="content-1">
					...
					<div id="answer-parents">
						<p>Just because your kids learn programming doesn’t mean your kids have to become a programmer.</p>
						<p>The same can be applied to other educations. Just because your kids learn arts and crafts, and music doesn’t mean they have to become a painter or musician.</p>
						<p>Do you know the real reason why kids need to learn programming?</p>
						<p>The 21st century is an era of rapid change.</p>
						<p>There is no single answer to address the issues that arise from an increasingly complex world. We need to come up with multiple solutions through trial and error to realize our idea. That’s what it takes to survive in the 21st century.</p>
						<p>However, realizing our idea requires logical thinking and creativity.</p>
						<p>Programming is structured and layered by sequence, selection, and iteration. Therefore, if you learn programming, you will naturally obtain an ability to critically analyze and logically think what you see.</p>
						<p>On top of this, there is no absolute single solution in programming.</p>
						<p>There is not a correct answer but multiple alternative answers. Programming is similar to LEGO. Programming helps you develop your creativity because you can code the program based on your own imagination.</p>
						<p>Of course, if you master programming, you can obtain an IT skill to freely control IT devices and to realize what you want to do.</p>
						<p>If your kids develop logical thinking and creativity, and obtain an ability to realize their idea, they can survive in the 21st century without doubt.</p>
						<p>Programming provides your kids with the idea on how to use their brain.</p>
					</div>
				</div>
				<div id="content-2">
