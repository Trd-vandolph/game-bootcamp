<section id="contents" class="how">
	<div class="content-how content-text">
		<div id="content">
			<p class="sub-catch">Take the following steps to join the course.</p>
				<div class="sub-catch howjoin">
					<ol class="intruct">
						<li><h3>Sign Up</h3><p>Go to "SIGNUP" and register your profile.</p></li>
						...
						<li><h3>Take Trial Lesson</h3><p>Before you decide to start the course, take a free trial lesson with one of our <a class="open" href="/tutor">tutors.</a></p></li>
						<li><h3>Pay Course Fee</h3><p>If you want to start the course, pay <a class="open" href="/coursefee">course fee.</a></p></li>
						<li><h3>Book First Lesson</h3><p>Once we confirm your payment, you can book the first lesson.</p></li>
					</ol>
				</div>
		</div>
	</div>
