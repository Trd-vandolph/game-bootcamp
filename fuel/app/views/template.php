					...
					<div class="col span_9 col_last">
						...
						<nav>
							<ul class="sf-menu">
								...
								<li id="menu-item-2862" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2862 editable"><a href="/parents"><? echo Session::get('menu2'); ?></a>
								</li>
								<!-- li id="menu-item-2718" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2718 editable"><a href="/try"><? echo Session::get('menu3'); ?></a>
								</li-->
								<li id="menu-item-2720" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2720 editable"><a href="/course"><? echo Session::get('menu4'); ?></a>
								</li>
								<li id="menu-item-2722" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2722 editable"><a href="/tutor"><? echo Session::get('menu5'); ?></a>
								</li>
