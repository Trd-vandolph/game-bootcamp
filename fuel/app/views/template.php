					...
					<div id="search-box">
						<div class="col span_12">
							<form action="http://bootcamp.csp.edu/" method="GET">
								<input type="text" name="s" value="Start Typing..." data-placeholder="Start Typing..." /> </form>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col span_3">
						<a id="logo" href="/"> <img class="" alt="CSP Bootcamp" src="assets/img/logo/logo2_b.png" /> <img class="starting-logo " alt="CSP Bootcamp" src="assets/img/logo/logo2-trans.png" /> <img class="starting-logo dark-version " alt="CSP Bootcamp" src="assets/img/logo/logo2_b.png" /> </a>
					</div>
					<div class="col span_9 col_last"> <a href="#mobilemenu" id="toggle-nav"><i class="icon-reorder"></i></a>
						<nav>
			...
			<div class="container">
				<div class="col span_5">
					<p>Game-BootCamp - Online Game Development Course
						...
						<br> <a href="privacy-policy/index.html">Privacy Policy</a> </p>
				</div>
				<div class="col span_7 col_last">
					<div class="powered"> <span>Operating Company:</span>
