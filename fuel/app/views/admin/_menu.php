<div id="side">
	...
	<nav>
		<ul>
			<li><? echo Html::anchor('/admin/students', '<i class="fa fa-fw fa-graduation-cap"></i> Student management'); ?></li>
			<li><? echo Html::anchor('/admin/teachers', '<i class="fa fa-fw fa-user"></i> Teacher management'); ?></li>
			<li><? echo Html::anchor('/admin/reservations', '<i class="fa fa-fw fa-calendar"></i> Reservation management'); ?></li>
			...
			<li><? echo Html::anchor('/admin/mail', '<i class="fa fa-fw fa-pencil-square-o"></i> Mail management'); ?></li>
		</ul>
	</nav>
</div>