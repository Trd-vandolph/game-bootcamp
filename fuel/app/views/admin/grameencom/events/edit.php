		...
		<section>
			<div id="contents-wrap">
				<div id="main" class="new-m">
					<p class="view-events"><? echo Html::anchor("admin/grameencom/top", '<i class="fa fa-chevron-left"></i> Go back'); ?></p>
					...
					<section class="content-wrap">
						...
						<p class="button-area">
							...
							<input class="button" action="action" type="button" value="Back" onclick="history.go(-1);" />
						</p>
