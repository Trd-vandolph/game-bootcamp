...
<body>
<header>
	<h1><?php echo Html::anchor('/grameencom/',Asset::img('common/logo.png', array('alt'=> 'OliveCode'))); ?></h1>
	<nav>
		<ul>
			<? if($auth_status): ?>
			<li><? echo Html::anchor('/grameencom/?logout=1', '<i class="fa fa-sign-out"></i> Logout');
				?></li>
			<? endif; ?>
		</ul>
	</nav>
