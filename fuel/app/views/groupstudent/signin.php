	...
	<div class="content-wrap_s clearfix">
		<form action="" method="post">
			<div class="login-area">
				...
				<p class="forgotpassword"><? echo Html::anchor("groupstudent/forgotpassword", '<i class="fa fa-angle-right"></i> Forget Password ?'); ?></p>
			</div>
			<div class="signup-area">
				<div class="signup">
					<p>Sign up for a free trial lesson</p>
					<? echo Html::anchor("groupstudent/signup", 'Signup <i class="fa fa-chevron-right"></i>',array('class' => 'button')); ?>
				</div>
