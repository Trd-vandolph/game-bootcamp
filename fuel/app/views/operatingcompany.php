<section id="contents" class="operatingcompany">
	<div class="content-operating-company content-text">
		<div id="content">
			<ul>
				<li id="first-content" class="content-company">
					<ul>
						<li class="picture-content">
				...
				<li id="second-content" class="content-company">
					<ul>
						<li class="picture-content">
				...
				<li id="fourth-content" class="content-company">
					<ul>
						<li class="picture-content">
							<a href="http://www.olivecode.com/grameen" target="_blank"><img alt="Grameen and OliveCode Logo" src="../assets/img/front/banner.jpg" /></a><br><br><br>
							<a href="../assets/img/front/DSC_0766.jpg"><img src="../assets/img/front/DSC_0766.jpg" alt="Signing"/></a><br>
							<div align="center">
