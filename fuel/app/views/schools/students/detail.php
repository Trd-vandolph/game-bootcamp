<div id="contents-wrap">
	<div id="main">
		...
		<p class="link-more"><? echo Html::anchor("schools/students/add?id={$user->id}", '<i class="fa fa-plus-circle"></i>Edit'); ?></p>
		<section class="content-wrap">
				<ul class="forms">
					...
					<p class="button-area">
						<? echo Html::anchor("schools/students/changepassword/{$user->id}", 'Change password', ["class" => "button"]); ?>
					</p>
				</ul>
		</section>
		<ul class="histories">
