			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				<ul class="forms">
				    ...
				    -->
                        <h4>School Name</h4>
                        <div>
                            <input placeholder="School Name" name="school_name" type="text" required pattern=".{2,50}" style="width: 450px" title="must be less than 50 chars" value="<? echo Session::get_flash("school_name", ""); ?>">
                        </div>
					</li>
					<li>
						<h4>Gmail address</h4>
