...
class Controller_Grameencom_Events extends Controller_Grameencom
{
	...
	public function action_message($id){
		...
		$view = View::forge("grameencom/events/message", $data);
		$this->template->content = $view;
	}
	...
	public function action_view()
	{
		...
		$view = View::forge("grameencom/events/view", $data);
		$this->template->content = $view;
	}
	...
	public function action_all()
	{
		...
		$view = View::forge("grameencom/events/all", $data);
		$this->template->content = $view;
	}
}