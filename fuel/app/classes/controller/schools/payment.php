...
class Controller_Schools_Payment extends Controller_Schools
{
			...
			if(Input::post("amount", null) != null){	
				if(is_uploaded_file($_FILES["photo"]["tmp_name"])){	
					...
					if(move_uploaded_file($_FILES["photo"]["tmp_name"], $filepath)) {
						...
						Response::redirect("/schools/top/?m=1");
					}else{
						Response::redirect("/schools/payment/?e=1");
					}
				}else{
					Response::redirect("/schools/payment/?e=2");
				}
			}else {
				Response::redirect("/schools/payment/?e=3");
			}
		endif;
		$view = View::forge("schools/payment/index", $data);
