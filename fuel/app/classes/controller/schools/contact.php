...
class Controller_Schools_Contact extends Controller_Schools
{
	...
	public function action_index()
	{
		...
		if(Security::check_token()){
			if($val->run()){
				Response::redirect("schools/contact/confirm");
			}else{
				$errors = $val->error();
			}
		}
		...
		$view = View::forge("schools/contact/index");
	...
	public function action_confirm()
	{
		...
		$this->template->content = View::forge('schools/contact/confirm',$data);
	}
	...
	public function action_submit()
	{
		...
		$this->template->content = View::forge('schools/contact/finish');
	}
}
